...
arguments
    x {mustBeNumeric}
    f0 {mustBePositive} = default_emg_parameters().filter.notch_f0
    nyq {mustBePositive} = default_emg_parameters().fs / 2
    Q {mustBePositive} = default_emg_parameters().filter.notch_Q
end
